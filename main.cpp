...
const char* vid_file = "/home/zhangjing/zj/project/PedstrianDetect/build/data/tracking/MOT16-07.mp4";//"soccer.avi";                   /* input video file name */
int num_particles = PARTICLES;    /* number of particles */
int show_all = 1;             /* TRUE to display all particles */
bool isExport = false;               /* TRUE to exported tracking sequence */
